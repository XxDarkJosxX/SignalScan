...
<div class="main-banner wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="row">
          <div class="col-lg-6 align-self-center" style="padding-right: 80px;">
            <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
              <div class="row">
                <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
                  <h4 id="titulo-responsive">Soluciones a <em>Medida Para el Sector de las Telecomunicaciones</em> Inalámbricas</h4>
...
<div id="services" class="services section" style="margin-bottom: 1contactContainer0px;">
  ...
  <div class="container containercontent">
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="service-item second-service cardservice">
          <div class="icon"></div>
      ...
      <div class="col-lg-6">
        <div class="service-item third-service cardservice">
          <div class="icon"></div>
          <h4>Monitoreo y Alquiler de Equipos</h4>
          <p>Ofrecemos servicios de monitoreo de calidad eléctrica, <em> certificación de enlaces de datos</em> y alquiler de equipos para medición en telecomunicaciones.</p>
          <div class="text-button">
            <a onclick="openmodal()">Leer mas <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="service-item fourth-service cardservice">
          <div class="icon"></div>
    ...
    <div class="row vertical_content_manage mt-5">
      ...
      <div class="col-lg-6">
        <div class="img_about mt-3">
          <img style="border-radius:20px; filter: saturate(0.7);" src="https://i.ibb.co/qpz1hvM/About-us.jpg" alt="" class="img-fluid mx-auto d-block">
        </div>
      </div>
    </div>
